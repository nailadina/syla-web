...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('sbadmin/css/styleLogin.css') }}">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="name">
                ...
                <div class="sec-2">
                    ...
                    <input type="text" name="name" placeholder="naila dina" />
                </div>
            </div>
            <div class="email">
            ...
            <div class="footer"><a href="{{ route('login') }}"><span>Login</span></a><span>Forgot Password?</span></div>
        </form>
    </div>
    <!-- partial -->
